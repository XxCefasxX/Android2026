...
@Composable
fun Formulario() {
    var lista = rememberSaveable() { mutableListOf<Persona>() }
    ...
    Column() {
        ...
        MiTextField(value = nombre, onValueChange = { nombre = it }, label = "Nombre")
        MiTextField(value = edad, onValueChange = { edad = it }, label = "Edad")
        MiTextField(value = genero, onValueChange = { genero = it }, label = "Genero")
...
fun DatosPersona(nombre: String, edad: Int, genero: String,onClick: () -> Unit) {
    Card(
        ...
        Row {
            ...
            //personalizar y estilar el componente que muestra la info de la persona
            Image(
